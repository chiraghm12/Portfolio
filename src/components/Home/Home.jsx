                ...
                <div className="relative flex justify-between items-center gap-2 h-screen justify-items-center p-5">
                    <div className="p-50 text-white w-1/2">
                        <div className="pl-40 pt-20 font-sans">
                            ...
                            <p className="text-base pt-5 leading-7">I&apos;m a <span className="text-[#00abf0]">Software Developer</span> with a strong foundation in crafting scalable applications and solving complex problems. With experience in backend, frontend, and system integration, I thrive on turning ideas into impactful digital experiences.</p>
                            <div className="flex gap-x-5">
                                <button className="mt-7 px-5 py-3 font-bold rounded-sm bg-[#00abf0] flex items-center gap-x-2 duration-300 hover:shadow-[0px_0px_20px_10px_rgba(0,171,240,0.50)]" onClick={handleDownload}>
                                ...
                                <button className="mt-7 px-5 py-3 font-bold rounded-sm bg-[#00abf0] duration-300 hover:shadow-[0px_0px_20px_10px_rgba(0,171,240,0.50)]">
                                    <NavLink to="/contact">
                                        Contact Me
                                    </NavLink>
                                </button>
