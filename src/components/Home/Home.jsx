                ...
                <div className="flex justify-between items-center gap-x-2 mt-7">
                    <div className="text-white w-1/2">
                        <div className="pl-24 xl:pl-32 2xl:pl-40 font-sans">
                            <p className="xl:text-3xl 2xl:text-5xl font-bold">Hi, I&apos;m <span className="text-[#00abf0] tracking-tight">Chirag Mandaviya</span></p>
                            <p className="xl:text-2xl 2xl:text-4xl font-bold xl:pt-1 2xl:pt-3">Software Developer</p>
                            <p className="xl:text-sm 2xl:text-base xl:pt-3 2xl:pt-5 leading-7">I&apos;m a <span className="text-[#00abf0]">Software Developer</span> with a strong foundation in crafting scalable applications and solving complex problems. With experience in backend, frontend, and system integration, I thrive on turning ideas into impactful digital experiences.</p>
                            <div className="flex gap-x-5 xl:mt-5 2xl:mt-7">
