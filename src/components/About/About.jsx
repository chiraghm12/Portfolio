...
function About() {
    return (
        <>
            ...
            <div className="xl:text-3xl 2xl:text-5xl font-sans font-bold text-[#00abf0] text-center xl:p-10 2xl:p-10"><span className="text-white">ABOUT</span> ME</div>
            <div className="flex justify-between items-center gap-2 font-sans">
                <div className="xl:px-24 xl:py-5 2xl:px-36 2xl:py-10 w-1/2">
                ...
                <div className="xl:pr-20 2xl:pr-48 w-1/2 font-sans xl:text-xs 2xl:text-base">
                    <p className="text-left text-white leading-7 tracking-wide">
                    ...
                    <div className="xl:pt-3 2xl:pt-5 font-sans">
                        <p className="text-[#00abf0] font-bold xl:text-xl 2xl:text-3xl border-b-2 border-[#00abf0] flex gap-x-2">
                            ...
                            Education</p>
                        <p className="text-white xl:pl-2 2xl:pl-4 xl:pt-2 2xl:pt-4 font-bold">B.TECH, Computer Science & Engineering </p>
                        <NavLink to="https://nirmauni.ac.in/" target="_blank">
                            <p className="text-white xl:pl-2 2xl:pl-4 xl:pt-1 2xl:pt-2 flex xl:gap-1 2xl:gap-2">
                                Nirma University
                        ...
                        <p className="text-white xl:pl-2 2xl:pl-4 xl:pt-1 2xl:pt-2">June 2019 - June 2023 | Ahmedabad, India</p>
                    </div>
